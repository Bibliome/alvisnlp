...
import fr.inra.maiage.bibliome.alvisnlp.core.corpus.expressions.AbstractBooleanEvaluator;
...
class FunctionModel {
	...
	FunctionModel(ModelContext ctx, ExecutableElement method, String firstFtor, String callMethod, int ftors, String[] nameTypes, int ord) throws ModelException {
		...
		if (needsEvalCtx && !ctx.isElement(params.get(1).asType()))
			throw new ModelException("the second parameter of this function implementation must be of type " + fr.inra.maiage.bibliome.alvisnlp.core.corpus.Element.class + ": " + method);
	...
	private static enum ArgType {
		...
		ITERATOR(AbstractIteratorEvaluator.class, "java.util.Iterator<fr.inra.maiage.bibliome.alvisnlp.core.corpus.Element>", "evaluateElements"),
		LIST(AbstractListEvaluator.class, "java.util.List<fr.inra.maiage.bibliome.alvisnlp.core.corpus.Element>", "evaluateList"),
