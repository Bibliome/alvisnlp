...
public class TreeviewElementNode extends TreeviewNode<Element> {
	...
	public TreeviewElementNode(Element elt, String role, String rawText, String specificCSSClass, boolean hasChildren, String iconURL) {
		super(elt);
		this.role = role;
	...
	private static enum ElementToTreeviewNode implements ElementVisitor<TreeviewElementNode,String> {
		...
		public TreeviewElementNode visit(Annotation a, String param) {
			...
			return new TreeviewElementNode(a, param, rawText, "annotation-node", false, "/res/icons/ui-text-field.png");
		}

		@Override
		public TreeviewElementNode visit(Corpus corpus, String param) {
			return new TreeviewElementNode(corpus, param, "Corpus", "corpus-node", corpus.documentIterator().hasNext(), "/res/icons/documents-stack.png");
		}

		@Override
		public TreeviewElementNode visit(Document doc, String param) {
			return new TreeviewElementNode(doc, param, doc.getId(), "document-node", doc.sectionIterator().hasNext(), "/res/icons/blue-document.png");
		}

		@Override
		public TreeviewElementNode visit(Relation rel, String param) {
			return new TreeviewElementNode(rel, param, rel.getName(), "relation-node", !rel.getTuples().isEmpty(), "/res/icons/node.png");
		}

		@Override
		public TreeviewElementNode visit(Section sec, String param) {
			return new TreeviewElementNode(sec, param, sec.getName(), "section-node", (!sec.getAllRelations().isEmpty()) || (!sec.getAllAnnotations().isEmpty()), "/res/icons/document-text.png");
		}

		@Override
		public TreeviewElementNode visit(Tuple t, String param) {
			return new TreeviewElementNode(t, param, "Tuple", "tuple-node", t.getArity() > 0, "/res/icons/node-insert-child.png");
		}

		@Override
		public TreeviewElementNode visit(Element e, String param) {
			return new TreeviewElementNode(e, param, e.getClass().getSimpleName(), "element-node", false, "/res/icons/question-white.png");
		}
	}
