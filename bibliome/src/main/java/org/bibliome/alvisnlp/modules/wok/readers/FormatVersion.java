...
public enum FormatVersion implements FieldReader {
	V_1_0("1.0");
	
	public final String name;

	private FormatVersion(String name) {
		this.name = name;
	}
	...
	public void addLine(WoKReaderStatus status, String line) {
		if (!line.equals(name))
			throw new RuntimeException("wrong file format version: got " + line + ", expected " + name);
	}
