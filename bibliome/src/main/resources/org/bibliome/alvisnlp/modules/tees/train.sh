...
} && python $TEES_TRAIN_EXE --trainFile $TEES_TRAIN_OUT --develFile $TEES_DEV_OUT --testFile $TEES_TEST_OUT -o $WORKDIR --debug true && zip -r model $WORKDIR/model-test/* && cp -r $WORKDIR/model.zip $MODEL && 
