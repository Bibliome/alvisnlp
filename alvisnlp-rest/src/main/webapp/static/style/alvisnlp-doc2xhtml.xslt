...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="function">
	...
	<a class="function">
	  <xsl:attribute name="href">
	    <xsl:value-of select="concat(/alvisnlp-doc/@url-base, 'libraries/', @library, '#', @name, .)"/>
	  </xsl:attribute>
	  <xsl:value-of select="concat(@library, '#', @name, .)"/>
	</a>
      </xsl:when>
      <xsl:otherwise>
	<a class="function">
  ...
  <xsl:template match="module">
    <a class="module">
      <xsl:attribute name="href">
	<xsl:value-of select="concat(/alvisnlp-doc/@url-base, 'modules/', @name, .)"/>
      </xsl:attribute>
      <xsl:value-of select="concat(@name, .)"/>
    </a>
  </xsl:template>
  ...
  <xsl:template match="library">
    <a class="library">
      <xsl:attribute name="href">
 	<xsl:value-of select="concat(/alvisnlp-doc/@url-base, 'libraries/', @name, .)"/>
     </xsl:attribute>
     <xsl:value-of select="concat(@name, .)"/>
    </a>
  </xsl:template>
